package net.cmkj.framework.web.exception;
...
import net.cmkj.common.exception.DemoModeException;
import net.cmkj.common.exception.ServiceException;
import net.cmkj.common.utils.StringUtils;
import net.cmkj.common.utils.html.EscapeUtil;
...
public class GlobalExceptionHandler
{
    ...
    {
        String requestURI = request.getRequestURI();
        log.error("请求地址'{}',SaToken未登录异常.", requestURI, e);
        return new AjaxResult(HttpStatus.UNAUTHORIZED,e.getMessage());
    }
