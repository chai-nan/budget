...
import net.cmkj.common.annotation.DataScope;
import net.cmkj.common.core.domain.BaseEntity;
...
public class DataScopeAspect
{
    ...
    protected void handleDataScope(final JoinPoint joinPoint, DataScope controllerDataScope)
    {
        ...
        if (StringUtils.isNotNull(loginUser))
        {
            ...
            {
                String permission = StringUtils.defaultIfEmpty(controllerDataScope.permission(), String.join(",", StpUtil.getPermissionList()));
