...
/**
 * 预算填报订制【计量器】版本数据对象 t_reporting_table_meter_version
 * 
 * @author cmkj
 * @date 2024-09-26
 */
@Data
@TableName("t_reporting_table_meter_version")
public class TableMeterVersion implements Serializable {
    @Serial
    ...
    /** 填报类型：1:安全类  2：非安全类 */
    @Excel(name = "填报类型：1:安全类  2：非安全类")
    private Integer reportingType;

    /** 项目类别：1:校准 2：维修 3：改造 */
    @Excel(name = "项目类别：1:校准 2：维修 3：改造")
