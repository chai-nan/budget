package net.cmkj.common.utils.poi;
...
import net.cmkj.common.utils.DictUtils;
...
public class ExcelUtil<T>
{
    ...
    public void exportExcel(HttpServletResponse response, List<T> list, String sheetName,Integer number)
    {
        this.number = number;
        exportExcel(response, list, sheetName, StringUtils.EMPTY);
    }
