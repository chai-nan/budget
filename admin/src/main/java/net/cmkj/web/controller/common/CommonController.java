package net.cmkj.web.controller.common;
...
import net.cmkj.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = CmkjConfig.getDownloadPath() + fileName;
            ...
            throws Exception
    {
        try
        {
            ...
            // 本地资源路径
            String localPath = CmkjConfig.getProfile();
            // 数据库资源地址
