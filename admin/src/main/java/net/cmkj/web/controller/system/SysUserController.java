...
import net.cmkj.common.core.domain.TreeSelect;
...
import net.cmkj.system.service.ISysPostService;
...
public class SysUserController extends BaseController
{
     ...
     * 修改用户
     */
    @SaCheckPermission("system:user:dit")
    ...
    {
        return userService.selectUserListAll(user);
    }
    ...
    public AjaxResult deptTree()
    {
        ...
        if(SysUser.isAdmin(getUserId())){
            treeSelects =  deptService.selectDeptTreeList(dept);
        }else{
            dept.setDeptId(getDeptId());
            List<TreeSelect> childrenList = deptService.selectDeptTreeList(dept);
            TreeSelect one = new TreeSelect();
            one.setId(1L);
            one.setLabel("郑州区域");
