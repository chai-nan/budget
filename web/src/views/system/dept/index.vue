<template>
   <div class="app-container">
      ...
      >
         ...
         <el-table-column label="部门属性" align="center" prop="type" >
        <template #default="scope">
      ...
      <el-dialog :title="title" v-model="open" width="600px" append-to-body>
         <el-form ref="deptRef" :model="form" :rules="rules" label-width="80px">
            <el-row>
               ...
               <el-col :span="12">
            <el-form-item label="部门属性" prop="type">
              <el-select
                     v-model="form.type"
                     placeholder="请选择"
                     clearable
...
const { sys_normal_disable,dept_type } = proxy.useDict("dept_type","sys_normal_disable");
