      ...
      <el-dialog v-model="dialogVisible" width='90%' draggable :close-on-press-escape='false'>
        <div class="dialogBox">
            ...
            <div class="right">
                ...
                <el-table  :summary-method="getSummaries" show-summary :data="visibleData.rightDataList"  height='80%' >
                    ...
                    <el-table-column  width="140" align="center" label='劳务派遣'  prop="labor"  >
                       
                    </el-table-column>
                    <el-table-column  align="center" label='合计'  prop="hj"  >
                    </el-table-column>
                    <el-table-column  align="center" label='福利费'  prop="welfare"  >
                       
                    </el-table-column>
                    <el-table-column  align="center" label='教育经费'  prop="education"  >
                       
                      </el-table-column>
                    <el-table-column  align="center" label='工会经费'  prop="unionFunds"  >
                      
                    </el-table-column>
                    <el-table-column  align="center" label='养老保险'  prop="endowment"  >
                       
                      </el-table-column>
                      <el-table-column  align="center" label='工伤保险'  prop="workInjury"  >
                       
                      </el-table-column>
                      <el-table-column  align="center" label='失业保险'  prop="unemployment"  >
                       
                      </el-table-column>
                      <el-table-column  align="center" label='医疗保险'  prop="medical"  >
                       
                      </el-table-column>
                      <el-table-column  align="center" label='生育保险'  prop="maternity"  >
                       
                      </el-table-column>
                      <el-table-column  align="center" label='社会保险费-单位部分'  prop="social"  >
                       
                      </el-table-column>
                      <el-table-column  align="center" label='住房公积金-单位部分'  prop="provident"  >
                       
                      </el-table-column>
                      <el-table-column  align="center" label='企业年金-单位部分'  prop="annuity"  >
                       
                      </el-table-column>
                      <el-table-column  align="center" label='研发经费'  prop="research"  >
                       
                      </el-table-column>
                      <el-table-column  align="center" label='总计'  prop="zj"  >
...
import {getLeftList,getRightData,updateStatus} from "@/api/taskExecution/wageBenefits/index" 
// getRightData 
...
async function handleNodeExpand(node, expandedRows){
  ...
  // if(node.hasOpen==false){
   let r= await getRightTable({itemId:visibleData.leftDataList[visibleData.leftIndex].id,selectType,taskId:visibleData.id})
    ...
    let res=await getRightData({taskId:visibleData.id,itemId:visibleData.leftDataList[visibleData.leftIndex].id,parentId:node.deptId,selectType})
