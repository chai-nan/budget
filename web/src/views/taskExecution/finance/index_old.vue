...
<template>
  <div class="app-container">
                ...
                <el-table-column :selectable="selectable" type="selection" width="55" align="center"  >
                  ...
                  <template   v-for="(item,index) in  visibleData.rightTableList" :key='index'>
                    ...
                    <el-table-column  label="提交人"
                          prop="create_by" min-width='100'> 

                    </el-table-column>
                    <el-table-column  label="提交时间"
                          prop="create_time" min-width='100'> 
    ...
    <!-- 版本控制弹窗 -->
    <el-dialog v-model="dialogBbVisibleData.show" width='30%' title="生成版本" draggable top="20vh"   :close-on-press-escape='false'>
    ...
    <!-- 汇总弹窗信息 -->
    <el-dialog v-model="hzData.show" width='80%' title="" draggable top="40vh"   :close-on-press-escape='false'>
...
import {itemAuditField,reportingLog,getXZ,updateXZ,getLeftList,getRightTable,getRightData,getInfoForm,budgetSave,delTableItem,updateStatus} from "@/api/taskExecution/index"
