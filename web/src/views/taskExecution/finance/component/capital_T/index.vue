<template>
  <div style="width:100%;height: 100%;overflow: auto;">
     ...
     <div class='btnBox' >
          ...
          <el-table  :data="visibleData.rightDataList" height='87%' row-key="deptId"
              ...
              <el-table-column type="expand">
                <template #default="props">
                  ...
                  <el-table :data="props.row.dataTable"  @selection-change="(selection)=>handleSelectionChange(props.$index,selection)"   style="width:98%;margin:0 auto" height='400px'  size='small'  >
                    ...
                    <el-table-column  width="120" align="center"  label='填报人'  prop="user_name"  />
                ...
                >
                    ...
                    <template v-if='visibleData.tableName=="information_system"'>
                      ...
                      <el-table-column  :label="(year+1)+'年无形资产'" align="center" prop="intangibleAssets" >
                            <template #default="scope">
                              ¥ {{ formatNumber(scope.row.intangibleAssets) }}
                            </template>
 ...
 import {getDeptList,itemInfoTj} from "@/api/taskExecution/index"
...
if (valid) {
  updateStatus(obj).then(async res=>{
    ...
    console.log(visibleData.rightDataList)
